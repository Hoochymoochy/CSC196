...
int main(int argc, char* argv[]) {
    ...
    while (!quit) {
        ...
        for (auto& star : stars) {
            ...
            viper::GetEngine().GetRenderer().SetColor((uint8_t)viper::random::getRandomInt(256), (uint8_t)viper::random::getRandomInt(256), (uint8_t)viper::random::getRandomInt(256));
